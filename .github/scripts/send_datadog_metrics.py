# .github/scripts/send_datadog_metrics.py
import os
import requests
...
def send_metric(api_key, metric_name, value, tags=None):
    url = "https://api.datadoghq.com/api/v1/series"  # Update to EU endpoint if necessary
    headers = {
...
def main():
    ...
    # Optionally include run_url if it's not empty
    if run_url:
